    ...
    return (
        <div>
            ...
            <div className="candidate_navigation">
                <small className="logo mt_10 ml_10"><a href="/">SQUIRRELL</a></small>
                    ...
                    <div>
                        ...
                        <div className="row candidate_body">
                            <div className="first col-md-3">
                                ...
                                <div className="laravel d-flex justify-content-between">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M11.7803 12.2803C11.4874 12.5732 11.0126 12.5732 10.7197 12.2803L9 10.5607L7.28033 12.2803C6.98744 12.5732 6.51256 12.5732 6.21967 12.2803C5.92678 11.9874 5.92678 11.5126 6.21967 11.2197L7.93934 9.5L6.21967 7.78033C5.92678 7.48744 5.92678 7.01256 6.21967 6.71967C6.51256 6.42678 6.98744 6.42678 7.28033 6.71967L9 8.43934L10.7197 6.71967C11.0126 6.42678 11.4874 6.42678 11.7803 6.71967C12.0732 7.01256 12.0732 7.48744 11.7803 7.78033L10.0607 9.5L11.7803 11.2197C12.0732 11.5126 12.0732 11.9874 11.7803 12.2803Z" fill="#151417" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M9 2C4.85786 2 1.5 5.35786 1.5 9.5C1.5 13.6421 4.85786 17 9 17C13.1421 17 16.5 13.6421 16.5 9.5C16.5 5.35786 13.1421 2 9 2ZM3 9.5C3 6.18629 5.68629 3.5 9 3.5C12.3137 3.5 15 6.18629 15 9.5C15 12.8137 12.3137 15.5 9 15.5C5.68629 15.5 3 12.8137 3 9.5Z" fill="#151417" />
                                    </svg>
                                </div>
                            ...
                            <div className="sec col-md-6">
                                ...
                                <div className="sec-seventh mt_20 ">
                                    <div className="header_sec_top">
                                        <div className=" left_div_buttons">
                                            <small>About</small>
                                        </div>
                                    </div>
                                    <p>Experienced Human Resources Executive with a demonstrated history of working in the internet industry. Skilled in Executive Search, Technical Recruiting, Sourcing, and Screening, backend work. Strong human resources professional with a Master of Business Administration (M.B.A.) focused in HR from Panjab University.</p>
                                </div>

                                <div className="sec-eight mt_20 ">
                                    <div className="header_sec_top">
                                        <div className=" left_div_buttons">
                                            <small>Skills</small>
                                        </div>
                                ...
                                <div className="sec-ninth mt_20 ">
                                    <div className="header_sec_top">
                                        <div className=" left_div_buttons">
                                            <small>Industries experience</small>
                                        </div>
                                    </div>
                                    <div className="skills_section_buttons">
                                        <button className="skill_btn">
                                ...
                                <div className="sec-tenth mt_20 ">
                                    <div className="header_sec_top">
                                        <div className=" left_div_buttons">
                                            <small>Whats included in hiring?</small>
                                        </div>
                                    </div>
                                    <p>We provide tracking with desktime software, free replacement of candidate if performance is not good, Project manager is included for reporting.</p>
                                </div>

                                <div className="sec-eleventh mt_20 ">
                                    <div className="header_sec_top">
                                        <div className=" left_div_buttons">
                                            <small>Availibility</small>
                                        </div>
                                    </div>
                                    <p>40 Hrs per week, 8 Hrs a day</p>
                                </div>
                            ...
                            <div className="third col-md-3">
                                <div className=" button_image mb_10">
                                    <button style={{ border: "none" }}>
                                        Ad
                                        <img className="pl_15 pr_15" src={require("../../assets/image/png/dots.png").default} />
                                    </button>
                                </div>
